 ...
 *  - 6.6 (friend/enemy bidirectionality): preserve BOTH directions
...
const VERSES = {
  1: {
    translation:
      "First the equation, with no softening: the engineer who performs prescribed work without depending on its fruit IS the renouncer AND the yogi. Not someone who has merely quit. Not someone who has merely reached inbox-zero or extinguished the build pipeline. Renunciation that is recognised here is renunciation of dependence on the result, not retreat from the action itself. The merely fireless engineer — the one who has stopped lighting any builds, stopped pushing any commits, stopped engaging the work — is, by this verse, neither sannyāsī nor yogī. The merely actionless engineer — quit Slack, quit standup, quit the on-call rotation — is, by this verse, the same: not yogi, not renouncer. The verse is sharp on both sides. The discipline that the chapter is about to describe begins with this collapse: the right inner orientation toward action and the right inner orientation toward renunciation are one orientation. Both depend on cutting the dependence on fruit, neither depends on quitting the work.",
    concrete_scenario:
      "A staff engineer at an ad-tech firm tells her director she is taking a sabbatical to 'finally stop chasing outcomes.' Three months later she is sitting in a coffee shop refreshing her old GitHub feed, watching her former pod ship a deploy without her, refreshing the engineering-blog homepage on Cloudflare, refreshing the Datadog public-status page on her phone. The dependence on fruit has not gone — it has merely lost its target. She has merely become the niragnir engineer of 6.1: the one without the Jenkins pipeline who tells herself she has renounced. Compare a peer in the same pod who never left: ships the migration, declines to refresh the launch-day metrics for the first hour, runs the on-call shift at 2 AM without rehearsing the post-mortem in advance, and at the next 1:1 says simply 'I did the merge; the conversion lift, whatever it is, isn't mine.' This second engineer is the verse's sannyāsī AND yogī. The first is neither. The verse rejects retreat-as-renunciation as firmly as it rejects fruit-grasping.",
    falsifiability:
      "The analog fails if a reader interprets it as endorsing the Hustle-Through-Sabbaticals reading: that real engineers never rest. That misses the verse. The collapse is between renouncer and yogi at the level of inner orientation — both must have cut the dependence on fruit. A genuine sabbatical, taken because the work itself was complete or because illness required it, is not the verse's target. The target is the engineer who has merely transported their unrest to a quieter location.",
    counter_example:
      "When an engineer is in genuine burnout, when the body has actually given out, when a team's pathological culture has made present action impossible — leaving is the right action. The verse does not condemn that leaving. Krishna's target in 6.1 is the person who calls retreat-from-work renunciation, not the person who leaves a damaging situation to recover. The chapter's later consolation verses (6.37-6.45) explicitly cover the practitioner who has fallen from the practice; they are not destroyed.",
    implication:
  ...
  2: {
    translation:
      "The chapter sharpens the equation. What you have been calling renunciation is yoga; the two names point at the same orientation. The cut is at saṅkalpa — the desire-laden imaginings about results — not at action itself. Without abandoning these saṅkalpa-fancies no engineer becomes a yogi. The verse names something specific: the rehearsals you run in your head before the deploy, the mental preview of the dashboard reading, the imagined slack-thread of executives congratulating you, the imagined recruiter reaching out after the launch. Those imaginings are saṅkalpa. The engineer who has cut these has cut what 6.1 demanded; the engineer who has not has merely renamed their fruit-dependence as ambition. There is no path that bypasses the cut. The verse is operationally precise — neither path lets you keep the imaginings.",
    concrete_scenario:
      "A senior engineer at a fintech is preparing the announcement post for a Stripe-webhook reliability rewrite he has spent four months on. He notices, while drafting the GitHub release notes, that he has rehearsed the executive-Slack reaction six times this morning: the CTO's reply, the VP-Eng's bookmark, the DM from the recruiter who tried to poach him in February. He notices a second loop: the imagined response of his ex-manager, who had pushed back on the rewrite. The post is good; the rewrite is good; the launch is going to be fine. The saṅkalpa is what is not fine. He drafts the announcement, posts it, closes the laptop, walks to lunch. Three weeks later, when the dashboard does eventually show the latency improvement, he is half-surprised — he had not been refreshing it. That is the cut. The verse does not require him to feel nothing about the work; it requires him to stop running the rehearsals about its reception.",
    falsifiability:
      "The analog fails if a reader hears 'cut saṅkalpa' as 'never imagine the future.' Engineering planning explicitly requires forecasting outcomes (capacity planning, latency targets, rollout plans). The cut is at the desire-laden imaginings about the reception of the work, not at the operational forecasting of system behavior. An engineer who concludes that they should stop writing design docs has misread the verse.",
    counter_example:
      "When an engineer is doing legitimate forecasting — what a system will do under 10x traffic, what error budgets to set, what the rollback looks like — that is not saṅkalpa. The verse cuts at the loop that runs about you, not at the loop that runs about the system. A counterexample: the engineer who has cut their reception-rehearsals but still does rigorous capacity planning is exactly what the verse describes; the verse is not anti-foresight.",
    implication:
  ...
  3: {
    translation:
      "Krishna distinguishes two stages of the practitioner. For the engineer climbing toward yoga — the muni still ascending — action is the means of ascent. For the same engineer once established, calm is the means by which higher practice proceeds. The verse is structural: it explains why the chapter will move shortly from action-instruction to meditation-instruction. The aspirant in year three of the practice does not have available the same operative means as the senior in year fifteen. For the year-three engineer the work itself — the migration, the deploy, the on-call shift — is what produces the discipline. For the year-fifteen engineer the active work has done what it can do; from that point onward calm — śama, the cessation of agitation — is what advances the practice further. Shankara reads the staging strictly; Ramanuja reads it as a continuum. Both agree that the means is staged.",
    concrete_scenario:
      "A senior tech lead at a SaaS company watches his team's two newest engineers, Jordan in their first year and Priya in their fifth. He gives them different advice and notices the pattern: with Jordan he is constantly assigning work — pick up the migration ticket, take the on-call shift, lead the post-mortem, draft the design doc for the Postgres-vector-store experiment. The work is what is making Jordan into an engineer. With Priya the advice has changed — she has done the migrations and the on-call shifts, twice each. Now what advances her practice is something different: the discipline of not picking up the next ticket the moment the prior one resolves; the discipline of holding a Datadog graph open for ten minutes without closing it; the discipline of saying nothing in standup when she has nothing useful to add. For Priya the means has shifted from action to śama. The TL recognises 6.3's structural claim in his own muscle-memory: he gives different advice to the two engineers because they are at different stages on the same staircase.",
    falsifiability:
    ...
    implication:
      "Locate yourself on the staircase honestly. If the work itself is still producing the discipline, do not skip ahead to śama. If the active work has done what it can do, do not refuse the calm that the next stage requires. The means is staged.",
    quotable_line:
  ...
  4: {
    translation:
      "Krishna names the diagnostic of yogārūḍha — the engineer ascended in yoga. Three marks: not attached to sense-objects (the dashboards, the vanity metrics, the launch posts, the Hacker News thread); not attached to the actions themselves (the rewrite, the on-call shift, the migration as identity); having renounced all saṅkalpas (the rehearsal-loops about reception). The verse closes the four-verse opening definition. 6.1 redefined renunciation; 6.2 anchored the cut at saṅkalpa; 6.3 staged the practice; 6.4 names the destination. The internal sequence is doctrinally complete. The verse is operational, not aspirational: Krishna names the marks by which the established yogi can be recognised — not the mood, not the self-report, but the structural detachment from the three pulls.",
    concrete_scenario:
      "A staff engineer at a cybersecurity firm is six years into a meditation-on-her-own-work practice. Her director runs through the diagnostic informally in a 1:1: 'Tell me the last three things you did that you cared about more than the dashboard.' She names three: the postgres index she added because the query was unsightly, not because the latency was load-bearing; the design doc she wrote for an internal service that no executive will ever read; the Slack-DM mentorship of a junior who is rotating off her team next week. None had a fruit she cared to track. Then the director asks: 'What did you decline last quarter?' She names a conference talk on Kubernetes operators that would have been good for her résumé and would have been bad for her week — declined cleanly. Then: 'What rehearsal-loop did you notice this morning?' She thinks. 'None today. There was one yesterday about the recruiter from Datadog.' The director nods. The three marks are present: not attached to sense-objects (the vanity-metric of the conference); not attached to actions (the postgres index was not identity-load-bearing); saṅkalpa-loops are noticed and let pass. She is yogārūḍha at the operational scope the chapter names.",
    falsifiability:
      "The analog fails if a reader uses it to claim that the engineer must feel nothing about their work. Detachment from fruit is not detachment from craft. The senior engineer who is attached to writing good code, who cares about the postgres index even though no executive will see it, is not violating 6.4. The verse cuts attachment to the reception of action, not attachment to the doing of action well.",
    counter_example:
  ...
  5: {
    ...
    translation:
      "uddhared ātmanātmānaṁ — let one lift the self by the self. The chapter's most engineering-resonant verse, and a sharp one: the engineer is the only lifter of the engineer. No mentor lifts the engineer who has not committed to lifting themselves. No manager lifts the engineer who has not committed. No team lifts the engineer who has not committed. No framework, no tool, no AI assistant, no career coach, no podcast, no productivity system substitutes for the practitioner's own commitment to lift themselves. The same self that is the lifter is also the one in danger of sinking — na ātmānam avasādayet, do not let the self sink. The two halves are one instruction: the only force that can raise the self is the self; the only force that can sink it is the self. Shankara reads ātman here as the empirical practitioner-self, not the supreme Self; Ramanuja reads it the same way at this stage. Both are explicit: the doctrine is operational, the practitioner is named as the only agent of the practitioner's elevation. The chapter's other verses presume this as their precondition.",
    concrete_scenario:
      "An engineer in his third year at a fintech is failing to make staff. He has read the company's promo rubric, watched the staff-engineer talks on YouTube, paid for an external coach, joined a peer-circle Slack, hired a writing tutor, and bought three career books. After six months of this assemblage of external lifts, his self-assessment in the perf cycle is the same as before. His manager, a fifteen-year senior, takes the perf doc, reads it, and says: 'None of these things will lift you. The coach won't lift you. I won't lift you. The peer circle won't lift you. The books won't lift you. The only thing that lifts you is the part of you that decides, this week, to spend the four hours of your Saturday writing the design doc for the rewrite no one has asked for, because you actually believe the system needs it. That commitment is the lifter. Without that commitment, every external scaffold around you is decoration.' The engineer recognises this. He cancels the coach. He starts the design doc the next Saturday. Eight months later he is staff. The mentor's remark was not the lifter; the mentor named what could only ever have been done from inside.",
    falsifiability:
      "The analog fails if a reader uses it to dismiss mentorship, peer learning, and good management. The verse does not say the lifter must lift in isolation. It says the lifter must lift themselves. A mentor can name the lift; a manager can clear obstacles; a peer can model the practice. None of them can do the lifting. The verse cuts the substitution-fantasy that some external agent will eventually do the work the practitioner has not done. Anyone who concludes that mentorship is useless has read the verse half-correctly; mentorship is useful precisely because it cannot substitute for the self's own commitment.",
    counter_example:
      "When an engineer is genuinely under-resourced — denied access to the codebase, blocked from the production system, refused tooling required for the work — the verse does not address that situation. Krishna in 6.5 is speaking to the practitioner who has the conditions for practice and is failing to lift themselves anyway. An engineer in a pathological organisation that prevents the practice has a different problem; the consolation comes later, in 6.37-6.45.",
    implication:
      "List the external scaffolds you are currently leaning on. For each, ask: is this naming the lift that I must still do, or is this substituting for the lift I have not committed to? Cut the second class. Keep the first class only if you are doing the lift it names.",
    quotable_line:
  ...
  6: {
    // PRESERVE BIDIRECTIONALITY: friend AND enemy.
    translation:
      "The bidirectional doctrine, sharp on both sides. For the engineer who has conquered the self, the self is the friend — the years of disciplined practice produce a self-system that supports the work. The morning routine, the focus blocks, the food and sleep discipline, the attention-control — these have become an ally that does the work without needing renegotiation. For the engineer whose self is unconquered, the self is the enemy — and not just unhelpful, the verse is precise here: śatru-vat, hostile-like, actively obstructing. Years of attention-fragmentation produce a self-system that opposes the work; the morning attention is gone before the work begins; the focus dissolves at the first notification; the body resists the chair; the mind runs the rehearsal-loops while the design doc remains unwritten. Both directions are structural, not motivational. Habits compound bidirectionally. The verse is not the soft self-help reading 'be your own friend'; it is the hard structural claim that the self-system is either the engineer's most reliable ally or their most reliable obstacle, and three years of practice determines which.",
    concrete_scenario:
      "Two engineers, both seven years into their careers. Marco's compounded habits: 6 AM wake without alarm, two hours deep work before Slack opens, design docs reviewed offline on weekends as a rest, runs three times a week, sleeps eight hours, watches no metrics during dinner. When a hard incident arrives at 3 AM PagerDuty, his self-system delivers a calm operator. When a Datadog dashboard climbs into the red during a launch, his attention is already where it needs to be. The conquered self is friend: the system Marco has built supports the work without his needing to summon it each morning. Compare Lena, also seven years in, also smart. Her compounded habits: phone at the bedside, the first scroll before standing, Slack open across breakfast, lunch eaten over the on-call dashboard, dinner interrupted by a Twitter argument with a competitor's eng-blog post. When a hard incident arrives at 3 AM, her self-system delivers a fragmented operator. When the dashboard climbs, her attention has already been split four ways since dawn. The unconquered self is enemy — not metaphorically; her own system actively obstructs the work she is trying to do. The verse names both directions structurally. Three years of either pattern, sustained, produces the corresponding self-system.",
    falsifiability:
      "The analog fails if a reader hears 'be your own friend' or 'develop self-compassion.' That is not what the verse claims. The verse names habits as structural, not motivational. The 'friend' direction is what disciplined practice has produced; the 'enemy' direction is what fragmented practice has produced. An engineer who interprets this verse as a self-talk instruction has trivialised it. The doctrine is about what the self-system delivers when the practice is needed, which is determined by what habits the practitioner has actually compounded.",
    counter_example:
  ...
  7: {
    translation:
      "For the engineer whose self is conquered, who is fully calmed, the supreme self is concentrated — across cold and heat, pleasure and pain, honor and dishonor. The verse extends 2.55-2.72's sthita-prajña diagnostic into the dhyāna-yoga frame. The diagnostic is precise across three pairs: physical extremes (cold/heat), affective extremes (pleasure/pain), and social extremes (honor/dishonor). The senior engineer's response-shape to the office heater being broken is the same as to the AC overshooting; the response-shape to the launch celebration is the same as to the post-mortem; the response-shape to being named in the all-hands is the same as to being named in the Slack thread that complains about their architecture. The state is not 'doesn't feel'; it is 'doesn't disturb the concentrated state.' Shankara reads paramātmā as the supreme Self that becomes manifest as fully concentrated in such a person; Ramanuja reads it as the higher discriminating self, samāhita with concentration on the divine. Engineering scope: the operational rung is reachable; the metaphysical ladder above it exceeds engineering reach.",
    concrete_scenario:
      "A staff engineer at a video-streaming company runs a postmortem on a 30-minute regional outage that took out 4% of streams during a Saturday-night spike. The room is tense; the on-call who paged her at midnight is anxious; the VP-Eng is in the back. She walks the timeline; names where the rate-limiter sharded incorrectly; notes that her own architecture decision two years ago contributed; does not blame the on-call. Three weeks later the rewrite ships and the regional-failover MTTR drops 70%. The CEO names her in the all-hands; the same recruiter who reached out twice last year reaches out again. She replies politely, declines, returns to work. Watching her response-shape across the two scenes: the postmortem's heat and the all-hands' honor produce the same composure. Her dinner with her partner that evening is unaltered by either. Compare a peer at the same level whose response to honor is to glow visibly for a week and whose response to dishonor is to grind angrily for two; that peer is in 2.55's earlier stage. The verse's diagnostic is reachable but not automatic; the conquered-self of 6.6 is its precondition.",
    falsifiability:
  ...
  8: {
    translation:
      "Krishna gives the second equanimity-diagnostic: the yukta-yogi. The marks are four. Self satisfied with knowledge (jñāna, the theoretical) and discriminative knowledge (vijñāna, the experiential) — the engineer who has both read the systems papers and run the systems in production, satisfied by the joining of the two. Unmoving as a peak (kūṭastha) — the response-shape stable across the operational variations. Senses fully conquered (vijita-indriya) — the attention-control of 2.58's tortoise. And the threefold equality of clod, stone, and gold (sama-loṣṭa-aśma-kāñcana) — the practical test. The engineer for whom equity grants and the dollar value of a stack-overflow answer evoke the same response-shape; the operator for whom open-source contributions and FAANG-package headhunts evoke the same. The verse is operational on its surface and metaphysical underneath. The engineering scope is the operational rung — the senior whose external rewards do not differentiate their inner state.",
    concrete_scenario:
      "A principal engineer at a Series-D infrastructure startup receives, in the same week, three things: a $4M equity grant on a vesting refresh; a Slack DM from a junior thanking them for an architecture decision they made eighteen months ago that is now obviously the right one; and a recruiter pitch for a $1.2M base + sign-on at a FAANG. Watching their response-shape across the three: the equity grant evokes a brief pleasant note, then nothing; the junior's DM evokes the same brief pleasant note, then nothing; the FAANG pitch evokes the same brief pleasant note, then a polite decline. The clod-stone-gold test is operational here. The engineer's satisfaction-source has shifted to jñāna+vijñāna — the joining of what they know and what they have run. The external rewards land in the same category. The peer in the next office, eight years junior, is in a different state: the same week's equity grant produces three days of glowing; the recruiter pitch produces a week of mental rehearsal; the junior's DM produces a brief acknowledgment, then disappears. That peer is yukta-imminent, not yukta. The verse names the destination.",
    falsifiability:
  ...
  10: {
    ...
    translation:
      "Krishna pivots from disposition to practice. The yogi is to constantly yoke the self — in solitude (rahasi), alone (ekākī), with controlled mind and body (yata-cittātmā), without expectations (nirāśīr), without possessions (aparigrahaḥ). The verse opens the meditation-practice block. The four conditions are preconditions for the somatic instruction that follows. The engineering analog is approximate. The literal verse names solitude (no other person physically present), aloneness (no inner companion, no mental retinue), strict mind-body control, freedom from expectations, freedom from possessions — preconditions for a multi-hour seated meditation. The engineering analog at operational scope: the senior's deep-work setup. A workspace with the door closed; a phone in another room; a pre-decided two-hour block; no Slack open; no ambient browser tabs. Approximate, not identical. The verse's full somatic specificity exceeds what an engineering analog can preserve. Honest STRETCHED tag here: the literal aparigrahaḥ (no possessions) is not the engineering deep-work context; what the analog preserves is the structural commitment to the precondition-stack.",
    concrete_scenario:
      "A staff engineer at an LLM-tooling startup blocks Tuesday and Thursday mornings on her calendar. Tuesday at 9:00 AM she walks into a small home office, closes the door, sets her phone face-down on the kitchen counter outside, opens her laptop with no browser tabs except the design-doc draft and the codebase, and begins. The next two hours are unbroken. No Slack, no email, no ambient chat. She is in solitude in the operational sense (door closed, no person interrupting); alone in the partial sense (her own attention focused, no rehearsal-loop running); mind-body controlled (the chair is decent, the back is upright, the breath is settled into the rhythm of the work); free from expectations about how the design doc will be received (no rehearsal of the executive Slack); not in physical aparigraha (she still owns the apartment, the laptop, the savings account) but operationally in the engineering analog — the workspace contains nothing else for the next two hours. The block is the verse's analog at engineering scope. Honest naming: this is not the verse's literal practice. The yogi of 6.10 is in physical solitude in a forest hut; the engineer is in operational solitude in a closed-door home office. The structural commitment is preserved; the somatic specificity is not.",
    falsifiability:
    ...
    implication:
      "Set up the operational analog of the four preconditions. A pre-decided block; no phone; no Slack; no ambient tabs. Run the analog twice a week, sustained over a year. The verse's operational rung is reachable; its full scope is not.",
    quotable_line:
  ...
  11: {
    ...
    translation:
      "Krishna's first piece of somatic instruction. The seat. Conditions named: in a clean place (śucau deśe); a firm seat (sthiram āsanam); neither too high nor too low (na ati-ucchritaṁ na ati-nīcaṁ); prepared with cloth, deer-skin, and kuśa-grass on top, in the order from below (cailājina-kuśottaram). Both Shankara and Ramanuja read this literally; this is yogic instruction in the technical sense, anticipating Patañjali's elaboration of āsana centuries later. The engineering analog is approximate at best. What the analog can preserve is the principle: the workspace setup is non-trivial. The clean place — a tidy desk, no clutter in the eyeline. The firm seat — a chair that supports the back without strain; not too high (knees compressed) not too low (back rounded). The layered preparation — keyboard at the right height, screen at eye level, lighting from the correct side. Honest STRETCHED tag: the verse's specific cailājina-kuśa specification is yogic somatic instruction at literal scope; the engineering analog operates at the much narrower operational scope of ergonomic workspace setup. The doctrinal point that the analog preserves is that workspace conditions are part of the practice, not preliminaries to it.",
    concrete_scenario:
      "A senior engineer at a research lab spends a Saturday afternoon redoing his home workspace. He buys a Herman Miller chair (the firm, neither-too-high-nor-too-low equivalent of the verse's āsanam). He buys a sit-stand desk and locks it at the height where his elbows meet the keyboard at 90 degrees (the engineering equivalent of na ati-ucchritaṁ na ati-nīcaṁ). He sets the monitor at eye-level so his neck does not strain (the engineering analog of the body-head-neck instruction that comes in 6.13). He removes everything from his desk except the keyboard, mouse, monitor, and a single notebook (the engineering analog of śucau deśe — the clean place). He arranges the lighting so it does not glare on the screen. The setup takes four hours and costs $2,400. Three weeks later he notices that his daily focus-block is sustained for forty-five minutes longer than before; his neck does not ache by 5 PM; he is shipping more cleanly. The workspace is part of the practice. The verse's literal instruction is not what he has done; what he has done is the engineering analog at operational scope. Honest STRETCHED — the verse asks for kuśa-grass, deer-skin, and cloth; he has Herman Miller and a sit-stand desk. The structural commitment to workspace conditions as part of the practice is preserved.",
    falsifiability:
  ...
  12: {
    ...
    translation:
      "The instruction continues. Having seated oneself on the prepared seat, with thought (citta) and sense-action (indriya-kriyā) controlled, with the mind made one-pointed (ekāgra), one should yoke yoga for self-purification (ātma-viśuddhi). The verse names the goal of this initial setup phase: not yet the highest samādhi, but ātma-viśuddhi — the cleansing of the inner system that prepares it for samādhi. Engineering analog at operational scope: having set up the workspace, having entered the focus block, with notifications silenced (yata-citta-indriya-kriyaḥ at the engineering scope), with the mind held on a single problem (ekāgram at the engineering scope), the engineer practices the focus-block for the cleansing-of-the-attention-system that compounds across years into the senior's settled state. Honest STRETCHED tag here: the verse's ātma-viśuddhi has metaphysical reach; the engineering analog is bounded by operational scope. The cleansing the verse names is the cleansing of the antaḥkaraṇa (inner organ) for samādhi-readiness; the engineering analog is the gradual cleansing of attention-defaults that accumulates across deep-work blocks sustained over years. The principle is real; the metaphysical scope exceeds the analog.",
    concrete_scenario:
      "An engineer at a search-infrastructure startup runs her Tuesday-morning focus block on a single problem: the latency regression in the new Lucene-replacement query path that has shown up only at p99. She has the workspace prepared (6.11 analog). She closes the door, silences notifications, opens only the codebase and the Datadog trace view. For the next ninety minutes she holds attention on the single problem: reads the trace, hypothesises about the segment-merge contention, runs a microbenchmark, reads three ElasticSearch papers on cold-cache semantics, returns to the trace, finds the actual cause in the lock contention during background merges. The mind has been one-pointed (ekāgram) on a single problem — yata-citta-indriya-kriyaḥ at engineering scope. Across two years of running this practice twice a week, her attention-defaults have shifted: she now finds it harder to scroll Twitter at the desk, harder to context-switch on a Slack ping, easier to hold a single problem for the full block. That gradual shift is the engineering analog of ātma-viśuddhi. Honest naming: the verse's ātma-viśuddhi reaches further than this — it is preparation for samādhi, which is not what a focus block produces. The structural compound (deep work cleansing the attention-system over years) is preserved; the metaphysical reach is not.",
    falsifiability:
      "The analog fails if a reader concludes that engineering deep work IS yogic meditation. It is not. The verse names ātma-viśuddhi as a definite stage in the path to samādhi; the engineering analog is the operational compounding of attention-discipline that supports the senior's settled state. Anyone who claims engineering deep work produces samādhi has inverted the chapter; chapter 6 itself reserves samādhi for verses 6.20-6.23 and treats it as a state beyond the operational rung.",
    counter_example:
